...
export default function AdminRegistrationsPage() {
  ...
  const filteredRows = useMemo(() => {
    ...
    return rows.filter((r) => {
      const matchesQuery = !q || [r.student_name, r.email, r.event_id, r.team_name].some((v) => String(v || '').toLowerCase().includes(q));
  ...
  return (
    <div className="space-y-3">
      <h1 className="page-title">Registration Monitoring</h1>
